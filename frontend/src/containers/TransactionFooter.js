  ...
  render() {
    return (<footer className="TransactionFooter fixed-bottom">
      <Stack bsPrefix={'charcot-transaction-footer-hstack'} direction="horizontal" gap={3}>
        ...
        <span
          className="charcot-transaction-footer-stat"><span>{Number.parseFloat(this.context.transactionData.size / Math.pow(2, 40)).toFixed(2)}</span> Terabytes Downloaded To Date</span>
