  ...
  return (
    <div className="Home">
      <div className="lander">
        <p className="text-muted section main">Multi-stain, multiregional digital neuropathology slides of the human brain
          throughout the lifespan of persons with no brain disorders or neurologic and psychiatric conditions. Specimens
          ...
          disorders range from psychiatric conditions such as schizophrenia and major depression to Alzheimer's disease,
          ...
          published criteria for clinical, neurological, and neuropsychiatric conditions, and objective criterion-based
        ...
        <p className="text-muted section">The available slides, which are updated roughly quarterly, are shown for
          specific demographic characteristics (age, race, sex), specific stains used (e.g., H&E, modified Bielschowski,
          amyloid beta, hyperphosphorylated tau), brain regions (e.g., middle frontal gyrus, hippocampus), and primary
          neuropathology diagnosis. Note that primary neuropathology diagnosis DOES NOT necessarily EXCLUDE the presence
        ...
        <p className="text-muted section">Although we are making these slide images freely and publicly available,
          ...
          internal purposes, record keeping, and reporting we would like to know who you are, how you intend to use the
        ...
        <p className="text-muted section">
          ...
          Henry J. and Erna D. Leir, Founders. Our laboratories have been supported by multiple grants from the NIH for
